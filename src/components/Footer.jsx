...
const addressList = [
    { iconName: 'icofont-google-map', text: ' hahahahahaha' },
    { iconName: 'icofont-phone', text: ' +84 123 456 789' },
...
const footerbottomList = [
    { text: 'Faculty', link: '#', }, { text: 'Staff', link: '#', }, { text: 'Students', link: '#', }, { text: 'Alumni', link: '#', },];
                            ...
                            <div className="footer-item our-address">
                                <div className="footer-inner">
                                    ...
                                    <div className="content">
                                        ...
                                        <ul className="lab-ul social-icons" style={{ marginTop: "20px", marginLeft:"-5px" }}>
                                            {
            ...
            <div className="footer-bottom">
                <div className="container">
                    <div className="section-wrapper">
                        <p>&copy; 2025 <Link to= "/" >Shop Cart</Link> Designed by<a href="/" target='_blank'>Hoang Quang Son</a></p>
